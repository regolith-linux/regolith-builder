...
SECOND_VERSION="focal"
THIRD_VERSION="groovy"
FOURTH_VERSION="hirsute"
...
echo "Copying $PACKAGE_NAME version $FIRST_VERSION to $FOURTH_VERSION in $STAGE"
./back-copy.sh $STAGE $FIRST_VERSION $STAGE $FOURTH_VERSION $PACKAGE_NAME